...
export default function Login() {
  ...
  return (
    <div className="lg:flex justify-between items-start">
      <div className="bg-[#F4F6FE] px-[4em] py-[3em] md:w-[80%] lg:w-[45%] mx-auto space-y-[2em] ">
        ...
        <form action="" className="text-ptb-dark  space-y-4  ">
          <div className="flex justify-between items-center w-full">
            <div className="w-[45%]">
              <Label
                title="First name"
                type="text"
                styleprops="bg-white border-none  "
              />
            </div>
            <div className="w-[45%]">
              <Label
          ...
          <ButtonPurple styleprops="w-full">SIGN UP</ButtonPurple>
